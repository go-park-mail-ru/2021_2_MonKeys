...
// CheckSubscription provides a mock function with given fields: ctx, userId
func (_m *UserRepository) CheckSubscription(ctx context.Context, userId uint64) (bool, error) {
...
// CreatePayment provides a mock function with given fields: ctx, paymentId, status, amount, userId
func (_m *UserRepository) CreatePayment(ctx context.Context, paymentId string, status string, amount string, userId uint64) error {
	ret := _m.Called(ctx, paymentId, status, amount, userId)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, uint64) error); ok {
		r0 = rf(ctx, paymentId, status, amount, userId)
	} else {
		r0 = ret.Error(0)
	}
...
// CreateSubscription provides a mock function with given fields: ctx, periodStart, periodEnd, userId, paymentId
func (_m *UserRepository) CreateSubscription(ctx context.Context, periodStart time.Time, periodEnd time.Time, userId uint64, paymentId string) error {
	ret := _m.Called(ctx, periodStart, periodEnd, userId, paymentId)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, time.Time, uint64, string) error); ok {
		r0 = rf(ctx, periodStart, periodEnd, userId, paymentId)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdatePayment provides a mock function with given fields: ctx, paymentId, status
func (_m *UserRepository) UpdatePayment(ctx context.Context, paymentId string, status string) error {
...
// UpdateSubscription provides a mock function with given fields: ctx, paymentId, activeState
func (_m *UserRepository) UpdateSubscription(ctx context.Context, paymentId string, activeState bool) error {
	ret := _m.Called(ctx, paymentId, activeState)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) error); ok {
		r0 = rf(ctx, paymentId, activeState)
	} else {
		r0 = ret.Error(0)
	}
